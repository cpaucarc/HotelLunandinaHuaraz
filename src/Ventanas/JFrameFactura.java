...
public class JFrameFactura extends javax.swing.JFrame {
    ...
    public JFrameFactura() {
        initComponents();
         this.setTitle("REPORTES - LUNAANDINA");
          ...
          String cabecera[] = {"RUC","Nombre", "Apellidos","Denominacion/Razon social","Servicios","ImporteTotal"};
        String dato[][] = {};
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(796, 573));

        jLabel1.setFont(new java.awt.Font("Futura Md BT", 0, 18)); // NOI18N
        jLabel1.setText("FACTURA - LUNANDINA");
